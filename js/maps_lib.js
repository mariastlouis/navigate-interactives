...
var MapsLib = {
  ...
  fusionTableId:      "1Fcq3y7uohbLe4lzL3o_JUvKKKeGiouJeQ8wTlVxZ",

  //*New Fusion Tables Requirement* API key. found at https://code.google.com/apis/console/
  //*Important* this key is for demonstration purposes. please register your own.
  googleApiKey:       "AIzaSyAaH_zNoCbUD_qVPqGCFljElqIfu2Eu3N4",
  ...
  map_centroid:       new google.maps.LatLng(38.89744587262293, -104.6282958984375), //center that your map defaults to
  locationScope:      "Colorado",      //geographical area appended to all address searches
    ...
    if (address != "") {
      ...
      geocoder.geocode( { 'address': address}, function(results, status) {
        if (status == google.maps.GeocoderStatus.OK) {
          ...
          else if (MapsLib.searchRadius >= 1)     map.setZoom(16); // 1/4 mile
          else                                      map.setZoom(17);
